...
import (
	...
	eventtypequery "knative.dev/eventing/pkg/client/injection/informers/eventing/v1beta1/eventtypequery"
...
const (
	defaultControllerAgentName = "eventtypequery-controller"
	defaultFinalizerName       = "eventtypequeries.eventing.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	eventtypequeryInformer := eventtypequery.Get(ctx)

	lister := eventtypequeryInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "eventing.knative.dev.EventTypeQuery"),
	)
