...
// controller reconciling v1beta1.EventTypeQuery.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1beta1.EventTypeQuery. Any changes
	// to the objects .Status or .Finalizers will be propagated to the stored
	// object. It is recommended that implementors do not call any update calls
	// for the Kind inside of ReconcileKind, it is the responsibility of the calling
	// controller to propagate those properties. The resource passed to ReconcileKind
	// will always have an empty deletion timestamp.
	ReconcileKind(ctx context.Context, o *v1beta1.EventTypeQuery) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1beta1.EventTypeQuery.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1beta1.EventTypeQuery. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1beta1.EventTypeQuery) reconciler.Event
}

// ReadOnlyInterface defines the strongly typed interfaces to be implemented by a
// controller reconciling v1beta1.EventTypeQuery if they want to process resources for which
// they are not the leader.
type ReadOnlyInterface interface {
	// ObserveKind implements logic to observe v1beta1.EventTypeQuery.
	// This method should not write to the API.
	ObserveKind(ctx context.Context, o *v1beta1.EventTypeQuery) reconciler.Event
}

type doReconcile func(ctx context.Context, o *v1beta1.EventTypeQuery) reconciler.Event

// reconcilerImpl implements controller.Reconciler for v1beta1.EventTypeQuery resources.
type reconcilerImpl struct {
	...
	Lister eventingv1beta1.EventTypeQueryLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister eventingv1beta1.EventTypeQueryLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.EventTypeQueries(s.namespace)
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1beta1.EventTypeQuery, desired *v1beta1.EventTypeQuery) error {
	existing = existing.DeepCopy()
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		// The first iteration tries to use the injectionInformer's state, subsequent attempts fetch the latest state via API.
		if attempts > 0 {

			getter := r.Client.EventingV1beta1().EventTypeQueries(desired.Namespace)
		...
		updater := r.Client.EventingV1beta1().EventTypeQueries(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.EventTypeQuery) (*v1beta1.EventTypeQuery, error) {

	getter := r.Lister.EventTypeQueries(resource.Namespace)
	...
	patcher := r.Client.EventingV1beta1().EventTypeQueries(resource.Namespace)
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1beta1.EventTypeQuery) (*v1beta1.EventTypeQuery, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta1.EventTypeQuery, reconcileEvent reconciler.Event) (*v1beta1.EventTypeQuery, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
